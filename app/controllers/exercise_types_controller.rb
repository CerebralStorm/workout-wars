class ExerciseTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exercise_type.save
        format.html { redirect_to @exercise_type, notice: 'exercise_type was successfully created.' }
        format.json { render action: 'show', status: :created, location: @exercise_type }
      else
  ...
  def update
    respond_to do |format|
      if @exercise_type.update(exercise_type_params)
        format.html { redirect_to @exercise_type, notice: 'exercise_type was successfully updated.' }
  ...
  private
    ...
    def exercise_type_params
      params.require(:exercise_type).permit(:name, :category, :xp_multiplier, :use_reps, :use_distance, :use_duration, :use_weight, :use_calories)
    end
end